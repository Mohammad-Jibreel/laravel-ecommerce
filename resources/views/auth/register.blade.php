                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-2">
                        ...
                        <label for="exampleInputtext1" class="form-label">Name</label>
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" id="name" aria-describedby="textHelp" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
