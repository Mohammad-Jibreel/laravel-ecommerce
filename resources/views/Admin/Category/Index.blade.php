                                ...
                                <tr>
                                    ...
                                    <td class="border-bottom-0">
                                        <div class="d-flex align-items-center">
                                            <a class="btn btn-success m-1" asp-action="Edit" asp-area="Admin" asp-route-id="@item.Id" asp-controller="Category">
                                                <i class="ti ti-edit"></i>
                                            </a>
                                            <a class="btn btn-danger m-1" asp-action="Delete" asp-route-id="@item.Id" asp-area="Admin" asp-controller="Category">
