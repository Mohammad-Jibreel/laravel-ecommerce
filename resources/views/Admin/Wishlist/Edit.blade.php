...
<div class="container-fluid">
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">Edit  Wishlist</h5>
                <div class="card">
                    <div class="card-body">
                        <form method="post" asp-action="Edit" asp-controller="Wishlist" asp-area="Admin">
                            ...
                            <a asp-action="Index" asp-controller="Wishlist" asp-area="Admin" class="btn btn-success">Back</a>
