...
<div class="container-fluid">
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">Delete  Size</h5>
                <div class="card">
                    <div class="card-body">
                        <form method="post" asp-action="Delete" asp-asp-controller="Size"  asp-area="Admin">
