...
<div class="col">
    ...
    <a href="">
    <div class="card ">
                <div class="card-header bg-light-secondary bg-outline-secondary">
            Products
        </div>
        ...
        <a href="">
    <div class="card">
            <div class="card-header bg-light-danger bg-outline-danger">
            Categories
        </div>
    ...
    <div class="col">
        ...
        <a href="">
        <div class="card">
            <div class="card-header bg-light-warning bg-outline-warning">
                Users
            </div>


            <div class="card-body bg-light-warning bg-outline-warning">
        ...
        <a href="">
        <div class="card">
                <div class="card-header bg-light-primary bg-outline-primary">
                Orders
            </div>
                <div class="card-body bg-light-primary bg-outline-primary">
